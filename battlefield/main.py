...
def tournament():
    ...
    tournament_results = run_single_threaded_tournament(TOURNAMENT_CONFIG, num_games=10, granularity=2)
...
if __name__ == "__main__":
    ...
    # print_tournament_statistics(
    #     run_single_threaded_tournament(TOURNAMENT_CONFIG, num_games=10, granularity=1)
    # )
