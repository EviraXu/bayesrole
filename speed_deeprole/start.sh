...
# 定义日志文件路径
LOG_FILE="speed_deeprole_training_log.txt"
...
function train_section() {
    ...
    ./generate_deeprole_data.sh $NUM_SUCCEEDS $NUM_FAILS $PROPOSE_COUNT
    ...
    ./train_neural_network.sh $NUM_SUCCEEDS $NUM_FAILS $PROPOSE_COUNT
